...
const projects = [
  {
    ...
    gridClass: 'md:col-span-2 md:row-span-2' // Featured Large
  },
  {
    ...
    gridClass: 'md:col-span-1 md:row-span-1' // Small
  },
  {
    title: 'TECHSKOOP',
        ...
        <div className="mobile-slider lg:grid lg:grid-cols-3 lg:grid-rows-auto gap-6 pb-12">
          {projects.map((project, index) => (
            <a 
              ...
              className={`w-[85vw] lg:w-full group relative cursor-pointer mr-6 lg:mr-0 block h-full ${project.gridClass}`}
            >
              {/* Neon Light Glow Background */}
              <div 
                className="absolute inset-0 blur-[60px] rounded-[3.5rem] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none -z-10"
                style={{ backgroundColor: project.glowColor }}
              ></div>

              <div className="relative h-full min-h-[300px] lg:min-h-0 rounded-[2.5rem] md:rounded-[3rem] overflow-hidden glass border border-white/5 transition-all duration-700 hover:scale-[0.985] hover:border-white/20 bg-white/[0.02] flex flex-col">
                ...
                <div className="absolute inset-0 overflow-hidden">
                  ...
                  />
                  {/* Additional glass depth overlay */}
