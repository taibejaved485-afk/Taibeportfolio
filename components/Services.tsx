...
const ServiceCard: React.FC<{ service: typeof serviceData[0] }> = ({ service }) => (
  <div 
    className="flex-shrink-0 w-[280px] md:w-[340px] h-[420px] group relative p-8 glass border-white/5 rounded-[2.5rem] transition-all duration-500 hover:-translate-y-4 hover:bg-white/[0.04] flex flex-col mx-4"
  >
    <div 
  ...
  return (
    <section id="services" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <FloatingBox delay="0s" left={5} top={20} size="30px" color="#FB4EA0" />
        <FloatingBox delay="2s" left={85} top={10} size="45px" color="#3B82F6" />
        <FloatingBox delay="4s" left={40} top={80} size="25px" color="#00F3FF" />
        <FloatingBox delay="1s" left={70} top={60} size="40px" color="#FB4EA0" />
        <FloatingBox delay="3s" left={15} top={90} size="15px" color="#3B82F6" />
      </div>
